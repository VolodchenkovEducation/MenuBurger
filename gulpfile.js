...
// Передача объекта в глобальную переменную
global.app = {
...
// Наблюдатель за различными задачами
/* FTP --> Если необходимо, чтобы на сервере сразу обновлялись наши файлы, нужно менять задачу на: gulp.series(задача, ftp) */
function watcher() {
